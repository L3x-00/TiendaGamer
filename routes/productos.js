// Archivo: /routes/productos.js (Versión Robusta para PostgreSQL)
...
router.get('/', async (req, res) => {
  try {
    // Esta consulta es más robusta para PostgreSQL.
    // Usa DISTINCT ON para obtener solo la primera imagen por cada producto.
    const sqlQuery = `
    ...
    // Este log es crucial para depurar en Render
